...
function Payment(props) {
  ...
  let map = {
    "eTourist Visa(for 30 Days)": "99 USD",
    "eTourist Visa(for 1 Year)": "149 USD",
    "eTourist Visa(for 5 Years)": "249 USD",
    "eBUSINESS VISA": "249 USD",
    "eMEDICAL ATTENDANT VISA": "249 USD",
    "eMEDICAL VISA": "249 USD",
  };
  useEffect(() => {
        ...
        >
          <Grid container spacing={4} justifyContent="left">
              ...
              <Card>
                ...
                >
                  <div>
                    ...
                    associated with your payment card (debit/credit) in the form
                    given below. Otherwise, there will be higher chances of
                    payment failure
                  </div>
                  ...
                  <div style={{ marginTop: "15px" }}>
                    A review of your file will start once payment is successful.
                    You will receive an email which will contain your India
                    eVisa approval confirmation by the Indian Immigration
                    Authorities. The eVisa is an entry requirement to be able to
                    travel to India by air. Once your eVisa is approved, it will
                    be delievered to your email and linked to your passport
                  </div>
                </CardContent>
              </Card>
            </Grid>
            <Grid item xs={12} sm={4} md={4}>
              ...
              <div style={{ marginTop: "8px" }}>
                Standard processing time 24-48 hrs, in some cases it may 72 hrs.
              </div>
              <div style={{ fontWeight: "bold", marginTop: "8px" }}>Email</div>
              <div style={{ marginTop: "8px" }}>
                Please check your junk/spam folder in case if you didn't find
                email in your inbox.
              </div>
              <div style={{ marginTop: "8px", fontWeight:"bold"}}>Payment</div>
              <div style={{ marginTop: "8px" }}>
                Total amount:{" "}
                {formvalues?.visaService === "eTOURIST VISA"
                  ? formvalues?.visaOptions+ " - " +map[formvalues?.visaOptions]
                  : formvalues?.visaService+ " - " +map[formvalues?.visaService]}
              </div>
